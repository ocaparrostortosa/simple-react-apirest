                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <Grid container spacing={2}>
                        <Grid container item xs={6} direction="column">
                            ...
                            {/* Client name */}
                            <TextField id="outline-primary" label="Name" color="primary"
                            ...
                            {/* Client email */}
                            <TextField id="outline-primary" label="Email" color="primary"
                        ...
                        <Grid container item xs={6} direction="column">
                            ...
                            {/* Phone number */}
                            <MuiPhoneNumber
                                defaultCountry={'es'} className={classes.formPhone} value="phone"
